...
// ====================================================================
  ...
  static validateRoutineName(name: string, existing: Record<string, unknown>, originalName: string | null = null): { ok: true; name: string } | { ok: false; error: string } {
    const n = (name || "").trim();
