...
const DEFAULT_GOALS = {
  ...
  sodium: 2300,
  zinc: 11,
  // Adult reference intakes. A and folate in micrograms, D and B12 in
  // micrograms, C, E and B6 in milligrams — the units printed on labels.
  vitA: 900,
  vitC: 90,
  vitD: 15,
  vitE: 15,
...
const BASE_FOOD_LIBRARY = [
  { name: "Whole Eggs", serving: 100, unit: "g", cals: 143, p: 13.0, c: 0.7, f: 9.9, fiber: 0, sodium: 142, potassium: 138, calcium: 56, iron: 1.8, magnesium: 12, zinc: 1.3, vitA: 160, vitD: 2.0, vitE: 1.1, vitB6: 0.17, vitB12: 0.9, folate: 47, isBase: true, usageCount: 15 },
  { name: "Chicken Breast (Cooked)", serving: 100, unit: "g", cals: 165, p: 31.0, c: 0.0, f: 3.6, fiber: 0, sodium: 74, potassium: 256, calcium: 15, iron: 1.0, magnesium: 29, zinc: 1.0, vitA: 9, vitD: 0.1, vitE: 0.3, vitB6: 0.6, vitB12: 0.3, folate: 4, isBase: true, usageCount: 20 },
  { name: "White Rice (Cooked)", serving: 150, unit: "g", cals: 195, p: 4.1, c: 43.0, f: 0.4, fiber: 0.6, sodium: 1, potassium: 55, calcium: 16, iron: 1.8, magnesium: 19, zinc: 0.8, vitB6: 0.05, folate: 3, isBase: true, usageCount: 18 },
  { name: "Egg Whites", serving: 100, unit: "g", cals: 52, p: 11.0, c: 0.7, f: 0.2, fiber: 0, sodium: 166, potassium: 163, calcium: 7, iron: 0.1, magnesium: 11, zinc: 0.0, vitB12: 0.1, folate: 4, isBase: true, usageCount: 12 },
  ...
  { name: "Pasta (Dry)", serving: 80, unit: "g", cals: 280, p: 10.0, c: 58.0, f: 1.2, fiber: 2.5, sodium: 5, potassium: 180, calcium: 18, iron: 1.4, magnesium: 42, zinc: 1.1, vitE: 0.1, vitB6: 0.14, folate: 18, isBase: true, usageCount: 8 },
  ...
  { name: "Banana", serving: 118, unit: "g", cals: 105, p: 1.3, c: 27.0, f: 0.3, fiber: 3.1, sodium: 1, potassium: 422, calcium: 6, iron: 0.3, magnesium: 32, zinc: 0.2, vitA: 3, vitC: 8.7, vitE: 0.1, vitB6: 0.37, folate: 20, isBase: true, usageCount: 10 }
];
...
export { DEFAULT_GOALS, BASE_FOOD_LIBRARY, BASE_EXERCISE_DB, ROUTINE_PRESETS, ROTATION_SEQUENCE };
